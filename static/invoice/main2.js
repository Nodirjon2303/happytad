...
(function () {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{ "function": "__e" }],
            "tags": [{ "function": "__rep", "vtp_containerId": "AW-1016700826", "vtp_remoteConfig": ["map", "enhanced_conversions", ["map", "M0blCO7drgMQmr_m5AM", ["map", "enhanced_conversions_mode", "off", "enhanced_conversions_automatic_settings", ["map"]]]], "tag_id": 1 }],
    ...
    */
    ...
    var Gd = function (a) { return null == a ? "" : k(a) ? Ca(String(a)) : "e0" }, Id = function (a) { return a.replace(Hd, "") }, Kd = function (a) { return Jd(a.replace(/\s/g, "")) }, Jd = function (a) { return Ca(a.replace(Ld, "").toLowerCase()) }, Nd = function (a) { a = a.replace(/[\s-()/.]/g, ""); "+" !== a.charAt(0) && (a = "+" + a); return Md.test(a) ? a : "e0" }, Pd = function (a) { var b = a.toLowerCase().split("@"); if (2 == b.length) { var c = b[0]; /^(gmail|googlemail)\./.test(b[1]) && (c = c.replace(/\./g, "")); c = c + "@" + b[1]; if (Od.test(c)) return c } return "e0" }, Sd = function (a,
        ...
        }, Qd = Object.freeze(["email", "phone_number", "first_name", "last_name", "street"]); var Zd = {}, U = G.google_tag_manager = G.google_tag_manager || {}, $d = Math.random(); Zd.ud = "3n1"; Zd.U = "dataLayer"; Zd.mh = "ChEI8P+PkgYQxcjenqSxtovfARImAL8b/fUvy1ZuOQvrlLYTXOReLRIUiSY6JOPI6zck4wfO9X+eygsaAgtP"; var ae = { __cl: !0, __ecl: !0, __ehl: !0, __evl: !0, __fal: !0, __fil: !0, __fsl: !0, __hl: !0, __jel: !0, __lcl: !0, __sdl: !0, __tl: !0, __ytl: !0 }, be = { __paused: !0, __tg: !0 }, ce; for (ce in ae) ae.hasOwnProperty(ce) && (be[ce] = !0); Zd.cc = "www.googletagmanager.com"; var de, ee = Zd.cc + "/gtm.js"; ee = Zd.cc + "/gtag/js"; de = ee;
    ...
    }, xe = function (a, b) { var c, d = 1 !== (void 0 === b ? 2 : b) ? ve(a) : me.get(a); "array" === tb(d) || "object" === tb(d) ? c = P(d) : c = d; return c }; var ye, ze = !1, Ae = function (a) { if (!ze) { ze = !0; ye = productSettings, productSettings = void 0; ye = ye || {} } return ye[a] }; var Be = function (a) {
    ...
    }, Eh = function () { return zh.test(G.location && G.location.hostname) }; var Gh = { F: "AW-1016700826", Zc: "" }, Hh = { Vj: "AW-1016700826", Mg: "AW-1016700826" }, Ih = function () { var a = []; Hh.Mg && (a = Hh.Mg.split("|")); return a };
